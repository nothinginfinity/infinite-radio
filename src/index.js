...
export default {
  async fetch(request, env) {
    ...
    if (request.method === "GET" && url.pathname === "/") {
      return new Response(
        `<!doctype html>
<html lang="en" data-step="v0.4-step-3">
<head>
  <meta charset="utf-8">
