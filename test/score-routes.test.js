...
test("root serves V0.5 focused local editor over replay-safe live continuity", async () => {
  ...
  assert.match(html, /id="editor-section-lift"/);
  assert.match(html, /id="editor-section-drop"/);
  assert.match(html, /id="editor-section-left"/);
  assert.match(html, /id="editor-section-duplicate"/);
  assert.match(html, /id="editor-section-right"/);
  ...
  assert.match(html, /command\.type==="section_duplicate"/);
  assert.match(html, /command\.type==="section_move"/);
  assert.match(html, /command\.type==="section_resize"/);
  assert.match(html, /function editorLinearSections\(score\)/);
